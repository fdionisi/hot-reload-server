...
exports.default = function (webpackConfig) {
  ...
  if (Array.isArray(webpackConfig)) webpackConfig.forEach(function (config) {
    return app.use(_path2.default.basename(config.output.path), _express2.default.static(config.output.path));
  });
  // Otherwise act as normal (webpackConfig is an object)
  else app.use(_path2.default.basename(webpackConfig.output.path), _express2.default.static(webpackConfig.output.path));
